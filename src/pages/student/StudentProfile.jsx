                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Grid container spacing={6}>
                            <Grid item xs={12} md={7}>
                                ...
                                <Box sx={{marginBottom:"26px"}}>
                                    <InputLabel sx={{marginBottom:"6px",fontSize:"13px"}}>{t('timezone')}</InputLabel>
                                ...
                                <Box sx={{marginBottom:"26px"}}>
                                    <InputLabel sx={{marginBottom:"6px",fontSize:"13px"}}>{t('location')}</InputLabel>
                                    <Controller
                                    name="location"
                                    control={control}
                                    render={({ field }) => (
                                ...
                                <Box sx={{marginBottom:"26px"}}>
                                    <InputLabel sx={{marginBottom:"6px",fontSize:"13px"}}>{t('nationality')}</InputLabel>
                                    <Controller
                                    name="nationality"
                                    control={control}
                                    render={({ field }) => (
                                ...
                                <RadioGroup {...field}>
                                    {
                                        ...
                                        levels?.data?.data.map((item,index)=>
                                        {
                                            ...
                                            key={index+'mnz'} value={item.id} control={<Radio size="2px"/>} label={lang==="ar"?item.titleAR:item.titleEN}/>
                                        })
                                    }
                                </RadioGroup>}
                                />
                                    ...
                                    <RadioGroup {...field}>
                                        {
                                            ...
                                            {
                                                return <FormControlLabel value={item.id} label={lang==="ar"?item.titleAR:item.titleEN} key={index+'ma'} 
