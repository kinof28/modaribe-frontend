        ...
        <Navbar>
            <Container sx={{marginTop:"120px"}}>
                <Paper sx={{width:{md:"450px"},padding:"30px 50px",margin:"60px auto"}}>
                    ...
                    <Typography sx={{fontSize:"28px",fontWeight:"600",marginBottom:"22px",textAlign:"center"}}>{t('register')}</Typography>
                    <Box sx={{marginBottom:"30px"}}>
                        <InputLabel sx={{marginBottom:"6px",fontSize:"13px"}}>{t('name')}</InputLabel>
                        <Controller
                        name="name"
                        control={control}
