            ...
            <Box sx={{marginTop:"30px",display:"flex",columnGap:"20px"}}>
                ...
                <Box>
                    ...
                    <Box sx={{display:"flex",columnGap:"4px",alignItems:"center",marginBottom:"8px"}}>
                        ...
                        <Typography sx={{color:"#4f4f51",fontSize:"14px",fontWeight:"bold"}}>{t('speaks')}: </Typography>
                    ...
                    <Box sx={{display:"flex",columnGap:"4px",alignItems:"center",marginBottom:"8px"}}>
                        ...
                        <Typography sx={{color:"#616161",fontSize:"14px"}}>{teacher?.experienceYears} {t('yearsofexperience')}</Typography>
                    </Box>
                    <Box sx={{display:"flex",columnGap:"4px",alignItems:"center",marginBottom:"8px"}}>
                    ...
                    <Box sx={{display:"flex",columnGap:"4px",alignItems:"center",marginBottom:"8px"}}>
                        ...
                        <Typography sx={{color:"#4f4f51",fontSize:"14px",fontWeight:"bold"}}>{t('subjects')}: </Typography>
                        <Typography sx={{color:"#616161",fontSize:"14px"}}>
                            {
                                lang==="ar"?
