...
import { useAdminStudentWallet } from '../../hooks/useAdminStudentWallet';
import { useSelector } from 'react-redux';
import Cookies from 'js-cookie';

export default function StudentHistoryWallet({id}) {
    ...
    { id: 'update', label:t('status'), minWidth: 150 }];
    ...
    const {data,isLoading} = useAdminStudentWallet(id,token)
